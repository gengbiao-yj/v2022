            ...
            >
              <template #suffix>
                <transition name="upDown" mode="out-in" appear>
                  <el-icon
                    v-if="filterForm.storeCode"
                    class="el-input__icon cur-pointer"
                    @click="filterForm.storeCode = ''"
                    ><CircleClose
                  /></el-icon>
